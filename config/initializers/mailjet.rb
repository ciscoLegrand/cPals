...
Mailjet.configure do |config|
  config.api_key = ENV.fetch('MAILJET_API_KEY', Rails.application.credentials.MAILJET_API_KEY)
  config.secret_key = ENV.fetch('MAILJET_SECRET_KEY', Rails.application.credentials.MAILJET_SECRET_KEY)
  config.default_from = ENV.fetch('MAILJET_SENDER_EMAIL', Rails.application.credentials.MAILJET_SENDER_EMAIL)
